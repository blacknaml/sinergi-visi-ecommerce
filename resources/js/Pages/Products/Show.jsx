                        ...
                        <div className="sticky top-24">
                            ...
                            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                                ...
                                <button
                                    ...
                                    className="flex h-14 flex-1 items-center justify-center gap-2 rounded-2xl bg-blue-600 px-8 font-black text-white shadow-xl shadow-blue-200 transition-all hover:bg-blue-700 hover:shadow-blue-300 disabled:opacity-50 active:scale-95"
                                >
